...
$TCA['tx_slubevents_domain_model_location'] = array(
	'ctrl' => $TCA['tx_slubevents_domain_model_location']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:slub_events/Resources/Private/Language/locallang_db.xlf:tx_slubevents_domain_model_location.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
		...
		'description' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:slub_events/Resources/Private/Language/locallang_db.xlf:tx_slubevents_domain_model_location.description',
			'config' => array(
				'type' => 'text',
				'cols' => 40,
				'rows' => 15,
		...
		'link' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:slub_events/Resources/Private/Language/locallang_db.xlf:tx_slubevents_domain_model_location.link',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
