 ...
 *  Copyright notice
 *
 *  (c) 2021 Alexander Bigga <alexander@bigga.de>
 *  All rights reserved
 *
...
/**
 * Migrate locate of contact photo files to new, FAL-based location
 */
class FileLocationUpdater implements UpgradeWizardInterface, ChattyInterface, LoggerAwareInterface
{
     ...
     * @var string
     */
    protected $sourcePath = 'uploads/tx_slubevents/';
     ...
     * @var string
     */
    protected $targetPath = '_migrated/tx_slubevents/';
    ...
    {
        return 'slubEventsFileLocationUpdater';
    }
